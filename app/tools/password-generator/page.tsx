      ...
      <main className="flex-grow py-6 sm:py-8 md:py-12">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="text-sm sm:text-base text-gray-900 px-4">Generate strong, secure passwords instantly</p>
          </div>

          <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 md:p-8 space-y-6">
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="text-sm font-medium text-gray-900">Password Length: {length}</label>
                <span className="text-xs text-gray-900">{length} characters</span>
              </div>
              <input
                type="range"
                min="4"
            ...
            <div className="space-y-3">
              <label className="block text-sm font-medium text-gray-900 mb-3">Include:</label>
              <div className="space-y-2">
                <label className="flex items-center space-x-3 cursor-pointer">
                  <input
                    ...
                    className="rounded"
                  />
                  <span className="text-sm text-gray-900">Uppercase Letters (A-Z)</span>
                </label>
                <label className="flex items-center space-x-3 cursor-pointer">
                  <input
                    type="checkbox"
                    ...
                    className="rounded"
                  />
                  <span className="text-sm text-gray-900">Lowercase Letters (a-z)</span>
                </label>
                <label className="flex items-center space-x-3 cursor-pointer">
                  <input
                    type="checkbox"
                ...
                <label className="flex items-center space-x-3 cursor-pointer">
                  <input
                    ...
                    className="rounded"
                  />
                  <span className="text-sm text-gray-900">Symbols (!@#$%...)</span>
                </label>
              </div>
            </div>
            ...
            {password && (
              <>
                <div className="bg-gray-50 rounded-lg p-4 border-2 border-gray-200">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-gray-900">Generated Password</span>
                    <button
